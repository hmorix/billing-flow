...
-- 10. Catalog Items (Products & Services with inventory and GST support)
...
-- 12. Package Items (Items bundled within a package)
...
-- 13. Inventory Logs (Audit trail for stock movement)
