...
// Lazy loading view components for optimal mobile bundle splitting
...
export const App: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', display: 'flex', flexDirection: 'column' }}>
      ...
      <Routes>
        {/* Full-screen mock stripe screens & template builder (Bypass default layout) */}
        <Route
        ...
        {/* Regular Sidebar & Responsive Shell Navigation Pages */}
        <Route
          path="*"
          element={
